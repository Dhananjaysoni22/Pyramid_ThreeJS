...
function Pyramid() {
  ...
  const textPosition = useControls("Text Position", {
    ...
    y: { value: 5.1, min: -40, max: 40, step: 0.1 },
    z: { value: 47.0, min: -80, max: 80, step: 0.1 },
  });
  ...
  const part1Pos = useControls('Part 1 Position', {
    ...
    y: { value: 0.89, min: -10, max: 10, step: 0.1 },
  ...
  const part3Pos = useControls('Part 3 Position', {
    ...
    z: { value: -0.85, min: -10, max: 10, step: 0.1 },
  });

  const WholePos = useControls('whole', {
    x: { value: 1.4, min: -50, max: 50, step: 0.1 },
    y: { value: -9.4, min: -50, max: 50, step: 0.1 },
  ...
  useEffect(() => {
    ...
    if (part1Ref.current && part2Ref.current && part3Ref.current && textRef.current) {
      ...
      part1Ref.current.position.set(-5, part1Pos.y, part1Pos.z);
      part2Ref.current.position.set(part2Pos.x, 5, part2Pos.z);
      part3Ref.current.position.set(5, part3Pos.y, part3Pos.z);
